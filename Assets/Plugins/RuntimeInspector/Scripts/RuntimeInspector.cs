...
namespace RuntimeInspectorNamespace
{
	public class RuntimeInspector : SkinnedWindow
	{
		...
		public delegate bool VariableFilterDelegate(string variableName);
...
#pragma warning restore 0649
		...
		private VariableFilterDelegate m_variableFilter;
		public VariableFilterDelegate VariableFilter
		{
			get { return m_variableFilter; }
			set
			{
				m_variableFilter = value;
				Refresh();
			}
		}
		...
		internal ExposedVariablesEnumerator GetExposedVariablesForType( Type type )
		{
			...
			if( allVariables == null )
				return new ExposedVariablesEnumerator( this, null, null, null, VariableVisibility.None, VariableVisibility.None );
			...
			return new ExposedVariablesEnumerator( this, allVariables, hiddenVariablesForType, exposedVariablesForType, m_exposeFields, m_exposeProperties );
		}
	}
}